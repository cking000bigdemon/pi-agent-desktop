...
- Default mode: `edge-tts` is installed (`"$PI_BUNDLED_PYTHON" -m pip install edge-tts`).
...
```bash
"$PI_BUNDLED_PYTHON" skills/ppt-master/scripts/notes_to_audio.py --list-voices --locale <locale>
```

**ElevenLabs backend**:

```bash
"$PI_BUNDLED_PYTHON" skills/ppt-master/scripts/notes_to_audio.py --provider elevenlabs --list-voices
```

**Cloud providers using explicit voice IDs/names**:

```bash
"$PI_BUNDLED_PYTHON" skills/ppt-master/scripts/notes_to_audio.py --provider minimax --list-voices
"$PI_BUNDLED_PYTHON" skills/ppt-master/scripts/notes_to_audio.py --provider qwen --list-voices
"$PI_BUNDLED_PYTHON" skills/ppt-master/scripts/notes_to_audio.py --provider cosyvoice --list-voices
```
...
"$PI_BUNDLED_PYTHON" skills/ppt-master/scripts/notes_to_audio.py <project_path> \
...
"$PI_BUNDLED_PYTHON" skills/ppt-master/scripts/svg_to_pptx.py <project_path> \
...
- (If skipped embedding) one-line hint on how to embed later: `"$PI_BUNDLED_PYTHON" skills/ppt-master/scripts/svg_to_pptx.py <project_path> --recorded-narration audio`.
