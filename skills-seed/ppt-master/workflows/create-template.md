...
```bash
"$PI_BUNDLED_PYTHON" skills/ppt-master/scripts/pptx_template_import.py "<reference_template.pptx>"
```
...
```bash
"$PI_BUNDLED_PYTHON" skills/ppt-master/scripts/svg_quality_checker.py "skills/ppt-master/templates/layouts/<template_id>" --template-mode --format <canvas_format>
```
...
```bash
"$PI_BUNDLED_PYTHON" skills/ppt-master/scripts/register_template.py <template_id>
```
...
>
> ```bash
> "$PI_BUNDLED_PYTHON" skills/ppt-master/scripts/register_template.py --rebuild-all
> ```
