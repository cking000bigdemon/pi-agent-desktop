...
5. Run the matching calculator command:
   ...
   "$PI_BUNDLED_PYTHON" skills/ppt-master/scripts/svg_position_calculator.py calc bar \
   ...
   "$PI_BUNDLED_PYTHON" skills/ppt-master/scripts/svg_position_calculator.py calc line \
     --data "x1:y1,x2:y2,..." --area "x_min,y_min,x_max,y_max" --y-range "0,max"

   # pie_chart
   "$PI_BUNDLED_PYTHON" skills/ppt-master/scripts/svg_position_calculator.py calc pie \
   ...
   "$PI_BUNDLED_PYTHON" skills/ppt-master/scripts/svg_position_calculator.py calc radar \
...
```bash
"$PI_BUNDLED_PYTHON" skills/ppt-master/scripts/svg_quality_checker.py <project_path>
```
...
```bash
"$PI_BUNDLED_PYTHON" skills/ppt-master/scripts/total_md_split.py <project_path>
"$PI_BUNDLED_PYTHON" skills/ppt-master/scripts/finalize_svg.py <project_path>
