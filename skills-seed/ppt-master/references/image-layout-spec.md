...
```bash
"$PI_BUNDLED_PYTHON" scripts/analyze_images.py <project_path>/images                    # Default: PPT 16:9
"$PI_BUNDLED_PYTHON" scripts/analyze_images.py <project_path>/images --canvas ppt43     # PPT 4:3
"$PI_BUNDLED_PYTHON" scripts/analyze_images.py <project_path>/images --canvas xiaohongshu  # Xiaohongshu
```
