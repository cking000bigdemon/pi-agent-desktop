...
"$PI_BUNDLED_PYTHON" skills/ppt-master/scripts/svg_to_pptx.py <project> -t push --transition-duration 0.6

# Disable
"$PI_BUNDLED_PYTHON" skills/ppt-master/scripts/svg_to_pptx.py <project> -t none

# Auto-advance every 5 seconds (kiosk-style playback)
"$PI_BUNDLED_PYTHON" skills/ppt-master/scripts/svg_to_pptx.py <project> --auto-advance 5
```
...
"$PI_BUNDLED_PYTHON" skills/ppt-master/scripts/svg_to_pptx.py <project>

# Disable per-element animation entirely
"$PI_BUNDLED_PYTHON" skills/ppt-master/scripts/svg_to_pptx.py <project> -a none

# Use a single effect (still cascades via the default after-previous trigger)
"$PI_BUNDLED_PYTHON" skills/ppt-master/scripts/svg_to_pptx.py <project> --animation fade

# Switch to on-click for live presentations (presenter controls pacing)
"$PI_BUNDLED_PYTHON" skills/ppt-master/scripts/svg_to_pptx.py <project> --animation-trigger on-click

# Custom pacing
"$PI_BUNDLED_PYTHON" skills/ppt-master/scripts/svg_to_pptx.py <project> --animation mixed \
        --animation-stagger 0.7 --animation-duration 0.5

# All groups animate in unison on slide entry
"$PI_BUNDLED_PYTHON" skills/ppt-master/scripts/svg_to_pptx.py <project> --animation-trigger with-previous
```
