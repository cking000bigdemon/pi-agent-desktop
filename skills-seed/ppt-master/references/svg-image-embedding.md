...
4. Preview: "$PI_BUNDLED_PYTHON" -m http.server -d <project_path> 8000 → /svg_output/<filename>.svg
...
```bash
"$PI_BUNDLED_PYTHON" -m http.server -d <project_path> 8000
...
```bash
"$PI_BUNDLED_PYTHON" scripts/svg_finalize/embed_images.py <svg_file>                         # Single file
"$PI_BUNDLED_PYTHON" scripts/svg_finalize/embed_images.py <project_path>/svg_output/*.svg    # Batch
"$PI_BUNDLED_PYTHON" scripts/svg_finalize/embed_images.py --dry-run <project_path>/svg_output/*.svg  # Preview
```
