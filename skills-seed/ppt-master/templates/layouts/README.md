...
| `variflight` | Brand | 公司对外汇报、产品介绍、商务演示、品牌物料 | `#0048AA` | 现代、商务、克制、品牌克制蓝 |
...
6. Validate the template directory with `"$PI_BUNDLED_PYTHON" scripts/svg_quality_checker.py templates/layouts/<template_name> --format ppt169`
