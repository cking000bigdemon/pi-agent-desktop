...
```bash
"$PI_BUNDLED_PYTHON" scripts/source_to_md/pdf_to_md.py <file.pdf>
# or
"$PI_BUNDLED_PYTHON" scripts/source_to_md/ppt_to_md.py <deck.pptx>
"$PI_BUNDLED_PYTHON" scripts/source_to_md/excel_to_md.py <workbook.xlsx>
"$PI_BUNDLED_PYTHON" scripts/project_manager.py init <project_name> --format ppt169
"$PI_BUNDLED_PYTHON" scripts/project_manager.py import-sources <project_path> <source_files...> --move
"$PI_BUNDLED_PYTHON" scripts/total_md_split.py <project_path>
"$PI_BUNDLED_PYTHON" scripts/finalize_svg.py <project_path>
"$PI_BUNDLED_PYTHON" scripts/svg_to_pptx.py <project_path>
```

Repository update:

```bash
"$PI_BUNDLED_PYTHON" scripts/update_repo.py
```
...
"$PI_BUNDLED_PYTHON" scripts/source_to_md/pdf_to_md.py <file.pdf>
"$PI_BUNDLED_PYTHON" scripts/source_to_md/ppt_to_md.py <deck.pptx>
"$PI_BUNDLED_PYTHON" scripts/source_to_md/doc_to_md.py <file.docx>
"$PI_BUNDLED_PYTHON" scripts/source_to_md/excel_to_md.py <workbook.xlsx>
"$PI_BUNDLED_PYTHON" scripts/source_to_md/web_to_md.py <url>
```
...
```bash
"$PI_BUNDLED_PYTHON" scripts/update_repo.py
"$PI_BUNDLED_PYTHON" scripts/update_repo.py --skip-pip
```
