...
```bash
"$PI_BUNDLED_PYTHON" scripts/source_to_md/pdf_to_md.py book.pdf
"$PI_BUNDLED_PYTHON" scripts/source_to_md/pdf_to_md.py book.pdf -o output.md
"$PI_BUNDLED_PYTHON" scripts/source_to_md/pdf_to_md.py ./pdfs
"$PI_BUNDLED_PYTHON" scripts/source_to_md/pdf_to_md.py ./pdfs -o ./markdown
```
...
```bash
"$PI_BUNDLED_PYTHON" scripts/source_to_md/doc_to_md.py lecture.docx
"$PI_BUNDLED_PYTHON" scripts/source_to_md/doc_to_md.py lecture.docx -o output.md
"$PI_BUNDLED_PYTHON" scripts/source_to_md/doc_to_md.py notes.epub
"$PI_BUNDLED_PYTHON" scripts/source_to_md/doc_to_md.py paper.tex -o paper.md  # uses pandoc
```
...
```bash
"$PI_BUNDLED_PYTHON" scripts/source_to_md/excel_to_md.py report.xlsx
"$PI_BUNDLED_PYTHON" scripts/source_to_md/excel_to_md.py report.xlsx -o output.md
"$PI_BUNDLED_PYTHON" scripts/source_to_md/excel_to_md.py report.xlsm --max-rows 200 --max-cols 40
```
...
```bash
"$PI_BUNDLED_PYTHON" scripts/source_to_md/ppt_to_md.py sales_deck.pptx
"$PI_BUNDLED_PYTHON" scripts/source_to_md/ppt_to_md.py sales_deck.pptx -o output.md
"$PI_BUNDLED_PYTHON" scripts/source_to_md/ppt_to_md.py ./decks
"$PI_BUNDLED_PYTHON" scripts/source_to_md/ppt_to_md.py ./decks -o ./markdown
"$PI_BUNDLED_PYTHON" scripts/source_to_md/ppt_to_md.py template.ppsx -o notes/template.md
```
...
```bash
"$PI_BUNDLED_PYTHON" scripts/source_to_md/web_to_md.py https://example.com/article
"$PI_BUNDLED_PYTHON" scripts/source_to_md/web_to_md.py https://url1.com https://url2.com
"$PI_BUNDLED_PYTHON" scripts/source_to_md/web_to_md.py -f urls.txt
"$PI_BUNDLED_PYTHON" scripts/source_to_md/web_to_md.py https://example.com -o output.md
```
...
```bash
"$PI_BUNDLED_PYTHON" scripts/rotate_images.py auto projects/xxx_files
"$PI_BUNDLED_PYTHON" scripts/rotate_images.py gen projects/xxx_files
"$PI_BUNDLED_PYTHON" scripts/rotate_images.py fix fixes.json
```
