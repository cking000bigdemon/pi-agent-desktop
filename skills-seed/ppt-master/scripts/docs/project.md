...
```bash
"$PI_BUNDLED_PYTHON" scripts/project_manager.py init <project_name> --format ppt169
"$PI_BUNDLED_PYTHON" scripts/project_manager.py import-sources <project_path> <source1> [<source2> ...]
"$PI_BUNDLED_PYTHON" scripts/project_manager.py validate <project_path>
"$PI_BUNDLED_PYTHON" scripts/project_manager.py info <project_path>
```
...
```bash
"$PI_BUNDLED_PYTHON" scripts/project_manager.py init my_presentation --format ppt169
"$PI_BUNDLED_PYTHON" scripts/project_manager.py validate projects/my_presentation_ppt169_20251116
"$PI_BUNDLED_PYTHON" scripts/project_manager.py info projects/my_presentation_ppt169_20251116
```
...
```bash
"$PI_BUNDLED_PYTHON" scripts/project_utils.py <project_path>
```
...
```bash
"$PI_BUNDLED_PYTHON" scripts/batch_validate.py examples
"$PI_BUNDLED_PYTHON" scripts/batch_validate.py examples projects
"$PI_BUNDLED_PYTHON" scripts/batch_validate.py --all
"$PI_BUNDLED_PYTHON" scripts/batch_validate.py examples --export
```
...
```bash
"$PI_BUNDLED_PYTHON" scripts/generate_examples_index.py
"$PI_BUNDLED_PYTHON" scripts/generate_examples_index.py examples
```
...
```bash
"$PI_BUNDLED_PYTHON" scripts/pptx_template_import.py <template.pptx>
"$PI_BUNDLED_PYTHON" scripts/pptx_template_import.py <template.pptx> -o <output_dir>
"$PI_BUNDLED_PYTHON" scripts/pptx_template_import.py <template.pptx> --manifest-only
"$PI_BUNDLED_PYTHON" scripts/pptx_template_import.py <template.pptx> --skip-manifest
"$PI_BUNDLED_PYTHON" scripts/pptx_template_import.py <template.pptx> --embed-images
"$PI_BUNDLED_PYTHON" scripts/pptx_template_import.py <template.pptx> --inheritance-mode both
"$PI_BUNDLED_PYTHON" scripts/pptx_template_import.py <template.pptx> --inheritance-mode flat
"$PI_BUNDLED_PYTHON" scripts/pptx_template_import.py <template.pptx> --inheritance-mode layered
```
...
```bash
"$PI_BUNDLED_PYTHON" scripts/error_helper.py
"$PI_BUNDLED_PYTHON" scripts/error_helper.py missing_readme
"$PI_BUNDLED_PYTHON" scripts/error_helper.py missing_readme project_path=my_project
```
