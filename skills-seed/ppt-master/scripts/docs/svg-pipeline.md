...
```bash
"$PI_BUNDLED_PYTHON" scripts/svg_to_pptx.py <project_path>
"$PI_BUNDLED_PYTHON" scripts/svg_to_pptx.py <project_path> --only native
"$PI_BUNDLED_PYTHON" scripts/svg_to_pptx.py <project_path> --only legacy
"$PI_BUNDLED_PYTHON" scripts/svg_to_pptx.py <template_import_output> --only native -s svg-flat
"$PI_BUNDLED_PYTHON" scripts/svg_to_pptx.py <project_path> --no-notes
"$PI_BUNDLED_PYTHON" scripts/svg_to_pptx.py <project_path> -t none
"$PI_BUNDLED_PYTHON" scripts/svg_to_pptx.py <project_path> --auto-advance 3
"$PI_BUNDLED_PYTHON" scripts/svg_to_pptx.py <project_path> --animation mixed --animation-duration 0.8
...
- Recorded narration is opt-in:
  ...
  - Voice choices can be listed with `"$PI_BUNDLED_PYTHON" scripts/notes_to_audio.py --list-common-voices`, `"$PI_BUNDLED_PYTHON" scripts/notes_to_audio.py --list-voices --locale zh-CN`, or provider-specific `--provider <name> --list-voices`
...
```bash
"$PI_BUNDLED_PYTHON" scripts/total_md_split.py <project_path>
"$PI_BUNDLED_PYTHON" scripts/total_md_split.py <project_path> -o <output_directory>
"$PI_BUNDLED_PYTHON" scripts/total_md_split.py <project_path> -q
```
...
```bash
"$PI_BUNDLED_PYTHON" scripts/svg_quality_checker.py examples/project/svg_output/01_cover.svg
"$PI_BUNDLED_PYTHON" scripts/svg_quality_checker.py examples/project/svg_output
"$PI_BUNDLED_PYTHON" scripts/svg_quality_checker.py examples/project
"$PI_BUNDLED_PYTHON" scripts/svg_quality_checker.py examples/project --format ppt169
"$PI_BUNDLED_PYTHON" scripts/svg_quality_checker.py --all examples
"$PI_BUNDLED_PYTHON" scripts/svg_quality_checker.py examples/project --export
```
...
```bash
"$PI_BUNDLED_PYTHON" scripts/svg_position_calculator.py calc bar --data "A:185,B:142" --area "130,155,1200,480" --bar-width 120
"$PI_BUNDLED_PYTHON" scripts/svg_position_calculator.py calc line --data "0:50,10:80,20:120" --area "120,120,1200,600" --y-range "0,150"
"$PI_BUNDLED_PYTHON" scripts/svg_position_calculator.py calc pie --data "A:35,B:25,C:20" --center "420,400" --radius 200
"$PI_BUNDLED_PYTHON" scripts/svg_position_calculator.py calc grid --rows 2 --cols 3 --area "50,150,1230,670"
```
...
```bash
"$PI_BUNDLED_PYTHON" scripts/svg_position_calculator.py analyze <svg_file>
```
...
```bash
"$PI_BUNDLED_PYTHON" scripts/svg_finalize/flatten_tspan.py examples/<project>/svg_output
"$PI_BUNDLED_PYTHON" scripts/svg_finalize/flatten_tspan.py path/to/input.svg path/to/output.svg
```

### `svg_rect_to_path.py`

```bash
"$PI_BUNDLED_PYTHON" scripts/svg_finalize/svg_rect_to_path.py <project_path>
"$PI_BUNDLED_PYTHON" scripts/svg_finalize/svg_rect_to_path.py <project_path> -s final
"$PI_BUNDLED_PYTHON" scripts/svg_finalize/svg_rect_to_path.py path/to/file.svg
```
...
```bash
"$PI_BUNDLED_PYTHON" scripts/svg_finalize/fix_image_aspect.py path/to/slide.svg
"$PI_BUNDLED_PYTHON" scripts/svg_finalize/fix_image_aspect.py 01_cover.svg 02_toc.svg
"$PI_BUNDLED_PYTHON" scripts/svg_finalize/fix_image_aspect.py --dry-run path/to/slide.svg
```
...
```bash
"$PI_BUNDLED_PYTHON" scripts/svg_finalize/embed_icons.py output.svg
"$PI_BUNDLED_PYTHON" scripts/svg_finalize/embed_icons.py svg_output/*.svg
"$PI_BUNDLED_PYTHON" scripts/svg_finalize/embed_icons.py --dry-run svg_output/*.svg
```
